...
from canonical_task_generation_sim_exp.evaluate_results import eval, save_eval_results, load_eval_results, avg_complex_task_acc, save_processed_results
...
def main(args):
    ...
    if args.load_test_users:
        ...
        users = create_user_archive(feat_space_range=(3, args.max_feature_space_size), num_users=args.num_test_users, weight_space=args.weight_space)
    ...
    if args.load_user_demos:
        ...
        worst_demos_df = simulate_user_demos.load_demos("wrong", args)
    else:
